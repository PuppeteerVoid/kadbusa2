        ...
        body: SingleChildScrollView(child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 20,),
              Text(
                "Were any of the following available at this hot spot during the last 12 months",
                style: TextStyle(
                  fontSize: 20,
                ),
                textAlign: TextAlign.center,
              ...
              Row(
                children: [
                  checkBox(),
                  Text(
                      "Safer sex education provide by NGO/CSO"
                  ),
                ],
              ),
              Row(
              ...
              Row(
                ...
                children: [
                  prev(link: question13()),
                  next(link: question15()),
                ],
              ),
            ],
          ),

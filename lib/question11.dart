...
import 'package:kadbusa/question10.dart';
        ...
        body:SingleChildScrollView( child:  Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 20,),
              Text(
                "How many PWUD individuals who come to this hot spot also use the internet/social media to arrange meetings with other key poulation individuals or clients?",
                style: TextStyle(
                  fontSize: 20,
                ),
                textAlign: TextAlign.center,
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  prev(link: question10()),
                  next(link: question12()),
                ],
              ),
            ],
          ),
